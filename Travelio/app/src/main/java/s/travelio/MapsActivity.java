...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    {int fare1=0;
        if(dist<=0.01)
        {fare1 = 4;}
        else if(dist>0.01 && dist<=0.02)
        {fare1 = 5;}
        else if(dist>0.02 && dist<=0.03)
        {fare1 = 7;}
        else if(dist>0.03 && dist<=0.05)
        {fare1 = 8;}
        else if(dist>0.05 && dist<=1.0)
        {fare1 = 11;}
        else if(dist>1.0 && dist<=1.2)
        {fare1 = 14;}
        else if(dist>1.2 && dist<=1.4)
        {fare1 = 15;}
        else if(dist>1.4 && dist<=1.7)
        {fare1 = 19;}
        else if(dist>1.7 && dist<=2.0)
        {fare1 = 21;}
        else if(dist>2.0 && dist<=2.5)
        {fare1 = 23;}
        else if(dist>2.5)
        {fare1 = 25;}
